...
base_model_path=/home/paz/code/phd/FaceFormer/vocaset/save_federated/clients_1_e_9_aggr_mask_data_split_vertical_dp_none_train_idx_-1_model_imitator_gen/model_round_24.pth #batched one
...
for test_subject in FaceTalk_170809_00138_TA FaceTalk_170731_00024_TA; do
    ...
    mv /home/paz/code/phd/FaceFormer/vocaset/save_federated/clients_1_e_${max_epoch}_aggr_${aggr}_data_split_stg_dp_${dp}_train_idx_0_model_imitator_stg02/ /home/paz/code/phd/FaceFormer/vocaset/save_federated/${test_subject}
done
