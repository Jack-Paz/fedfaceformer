...
class Faceformer(nn.Module):
    ...
    def forward(self, audio, template, vertice, one_hot, criterion,teacher_forcing=True, test=False):
        # tgt_mask: :math:`(T, T)`.
        ...
        if teacher_forcing:
            ...
            # print(vertice_input.shape, hidden_states.shape)
            # memory_mask = enc_dec_mask(self.device, self.dataset, frame_num, hidden_states.shape[1])
